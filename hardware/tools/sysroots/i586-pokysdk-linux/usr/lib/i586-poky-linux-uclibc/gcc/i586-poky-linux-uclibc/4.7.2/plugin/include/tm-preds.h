/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/jenkins_builder/workspace/GLLO_ToolChain-Linux32/meta-clanton_v1.0.1/yocto_build/tmp/work-shared/gcc-4.7.2-r20/gcc-4.7.2/gcc/config/i386/i386.md'.  */

...
#define __TARGET_SUBARCH__ "i486"
...
#define __KERNEL_HEADERS__ "/jenkins_builder/workspace/GLLO_BSP100.tar-1SPI/meta-clanton_v1.0.0/yocto_build/tmp/sysroots/clanton/usr/include"
...
#undef __LDSO_SAFE_RUNPATH__
#undef __LDSO_SEARCH_INTERP_PATH__
#undef __LDSO_LD_LIBRARY_PATH__
...
#define __CROSS_COMPILER_PREFIX__ "i586-poky-linux-uclibc-"
#define __UCLIBC_EXTRA_CFLAGS__ "-O2 -pipe -g -feliminate-unused-debug-types"
#undef __DODEBUG__
#undef __DOSTRIP__
#undef __DOASSERTS__
